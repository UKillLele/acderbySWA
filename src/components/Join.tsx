    ...
    return (
        <Container fluid className="content bg-dark text-light">
            <Row className="m-5 align-items-center">
                ...
                <Col lg="3">
                    <p className="text-end"><b>Just visiting?</b> Assessed skaters are welcome to drop in to practices for $5, just shoot an email to <a href="mailto:acrdwelcomewagon@gmail.com?subject=Join" target="_blank" rel="noreferrer">training</a>!</p>
                </Col>
            </Row>
            <Row className="my-5">
                <Col xs="12" lg="6" className="bg-black text-light p-5 d-flex align-items-center">
                    <Row className="me-lg-5">
                        <Col>
                            ...
                            <Row>
                                <Col>
                                    <p>Assassination City is looking for skaters 18 years or older to join our ranks. We abide by <a href="https://resources.wftda.org/womens-flat-track-derby-association-statement-about-gender" target="_blank" rel="noreferrer">WFTDA's Statement About Gender</a> and welcome all female-identifying and non-binary skaters and volunteers to join us in a love of derby.</p>
                                    ...
                                    <p>We hold Welcome Wagons on the first Sunday and Wednesday of every month.
                                        E-mail <a href="mailto:acrdwelcomewagon@gmail.com?subject=Join" target="_blank" rel="noreferrer">acrdwelcomewagon@gmail.com</a> or check out our <a href="https://www.facebook.com/AssassinationCityRollerDerby/" target="_blank" rel="noreferrer">Facebook page</a> to get more info.</p>
                                    <div className="my-5 text-center"><a href="mailto:acrdwelcomewagon@gmail.com?subject=Join" target="_blank" rel="noreferrer"><Button>Join Us</Button></a></div>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
                        ...
                        <Col>
                            ...
                            <Row>
                                <Col>
                                    ...
                                    <div className="my-5 text-center"><a href="mailto:ACRD.officials@gmail.com?subject=Join" target="_blank" rel="noreferrer"><Button>Officiate</Button></a></div>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
                        ...
                        <Col>
                            ...
                            <Row>
                                <Col>
                                    ...
                                    <div className="my-5 text-center"><a href="mailto:info@acderby.com?subject=Volunteer" target="_blank" rel="noreferrer"><Button>Volunteer</Button></a></div>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
                        ...
                        <Col>
                            ...
                            <Row>
                                <Col>
                                    ...
                                    <div className="my-5 text-center"><a href="mailto:info@acderby.com?subject=Photograph" target="_blank" rel="noreferrer"><Button>Photograph</Button></a></div>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
