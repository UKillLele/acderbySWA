        ...
        <Container fluid className="content bg-dark text-light">
            <Row className="header-img px-lg-5 mx-0">
                ...
                <div className="text-center bg-white rounded text-black p-3">
                    ...
                    <a href="https://acrdphotos.blob.core.windows.net/photos/2025%20Full%20sponsor%20packet.pdf" className="btn btn-primary" download>Check out our sponsorship brochure</a>
                </div>
            </Row>
            <Row className="justify-content-center px-5">
                ...
                <Col xs lg="4" className="text-center mt-5">
                    <a href="https://www.ihttps://urcomped.com/" target="_blank" rel="noreferrer" className="text-decoration-none">
                        ...
                        <div className="mt-0 border bg-light rounded p-3">
                            ...
                            <p className="pt-4 text-dark">Don't gamble on casino perks; trust URComped to get you the best casino and cruise offers!</p>
                        </div>
                    </a>
                </Col>
                <Col xs lg="4" className="text-center mt-5">
                    <a href="https://www.alexandmischaautorepair.com/" target="_blank" rel="noreferrer" className="text-decoration-none">
                        <Image className="skater-image" alt="Alex and Mischa Auto Repair" src="https://acrdphotos.blob.core.windows.net/photos/Alex%20and%20Mischa%20Auto%20Repair%20Logo.jpg" />
                        <div className="mt-0 border bg-light rounded p-3">
                            <p className="fs-3 m-0"><span className="text-nowrap">Alex and Mischa Auto Repair</span></p>
                            <p className="fs-3 m-0 text-dark">Marketing Whiz Sponsor</p>
                            <p className="pt-4 text-dark">Alex and Mischa are the MVPs of mobile auto repair. They'll get your car out of the sin bin before the jam is over.</p>
                        </div>
                    </a>
                </Col>
                <Col xs lg="4" className="text-center mt-5">
                    <a href="https://www.elevationsportsmed.com/" target="_blank" rel="noreferrer" className="text-decoration-none">
                        <Image className="skater-image bg-light" alt="Elevation Spine and Sports Medecine" src="https://acrdphotos.blob.core.windows.net/photos/Elevation%20Spine%20and%20Sports%20Medicine%20Logo.jpg" />
                        <div className="mt-0 border bg-light rounded p-3">
                            <p className="fs-3 m-0"><span className="text-nowrap">Elevation Spine and Sports Medecine</span></p>
                            <p className="fs-3 m-0 text-dark">Promote Sponsor</p>
                            <p className="pt-4 text-dark">Elevation Spine and Sports Medicine has our back! Stop by their table to let them get yours at our next bout!</p>
                        </div>
                    </a>
                </Col>
                <Col xs lg="4" className="text-center mt-5">
                ...
                <Col xs lg="4" className="text-center mt-5">
                    <a className="text-decoration-none">
                        <Image className="skater-image" alt="Boost Mobile Auto Detailing" src="https://acrdphotos.blob.core.windows.net/photos/Boost%20Logo.jpg" />
                        <div className="mt-0 border bg-light rounded p-3">
                            <p className="fs-3 m-0"><span className="text-nowrap">Boost Mobile Auto Detailing</span></p>
                            <p className="fs-3 m-0 text-dark">Promote Sponsor</p>
                            <p className="pt-4 text-dark">Boost Mobile Auto Detailing can make your car look as good as your favorite skater (but with fewer bruises)!</p>
                        </div>
                    </a>
                </Col>
                <Col xs lg="4" className="text-center mt-5">
                    <a href="https://www.instagram.com/kosbplano/" target="_blank" rel="noreferrer" className="text-decoration-none">
                        <Image className="skater-image h-100" alt="Knockout Sports Bar, Plano" src="https://acrdphotos.blob.core.windows.net/photos/Knockout%20Sports%20Bar.png" />
                        <div className="mt-0 border bg-light rounded p-3">
                            <p className="fs-3 m-0"><span className="text-nowrap">Knockout Sports Bar</span></p>
                            <p className="fs-3 m-0 text-dark">Afterparty Sponsor</p>
                            <p className="pt-4 text-dark">Want to hang out with the skaters? Meet us at the Plano location after the bout!</p>
                        </div>
                    </a>
                </Col>
            </Row>
